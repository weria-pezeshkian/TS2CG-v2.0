...
## Python Point Class
The Point class is the core of TS2CG regarding the Python scripts. The documentation of these python modules and the point class can be found here:<br>
...
### Notes
<!-- ECHECK WITH WERIA ABOUT LAST INT -->
...
<!-- Gromacs doesnt have whats a coment on their website -->
