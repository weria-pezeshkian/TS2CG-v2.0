...
## 5-1. Manual Method
## This script will generate a vesicle with three lipid domains (POPC, DOPC, and POPE) and three proteins. Each of the three proteins is positioned within a specific lipid domain. It will also run the TS2CG outputs in GROMACS
#===============================================================================================
...
if [[ "$user_input" == "yes" ]]; then
    ...
    ## regular
    $gmx_exec grompp -f $files/mdp/vesicle/em_2.mdp -c system.gro -r system.gro -p topol.top -o output_1/em_2.tpr
